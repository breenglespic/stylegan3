...
def init_egl():
    ...
    surface_attribs = [egl.EGL_WIDTH, 1, egl.EGL_HEIGHT, 1, egl.EGL_NONE]
    ...
    def blit(self, dst=None):
        ...
        with self.bind():
            ...
            gl.glBlitFramebuffer(
                0, 0, self.width, self.height, 0, 0, self.width, self.height, gl.GL_COLOR_BUFFER_BIT, gl.GL_NEAREST
            )
