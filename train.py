...
@click.option(
    "--cfg", help="Base configuration", type=click.Choice(["stylegan3-t", "stylegan3-r", "stylegan2"]), required=True
)
...
@click.option(
    "--p",
    help="Probability for --aug=fixed",
    metavar="FLOAT",
