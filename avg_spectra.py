...
@click.option(
    "--std",
    help="Dataset standard deviation for whitening",
    metavar="FLOAT",
...
@click.option(
    "--beta",
    help="Shape parameter for the Kaiser window",
    metavar="FLOAT",
    type=click.FloatRange(min=0),
    default=8,
    show_default=True,
...
@click.option(
    "--interp",
    help="Frequency-domain interpolation factor",
    metavar="INT",
...
@click.option(
    "--dpi", help="Figure resolution", metavar="FLOAT", type=click.FloatRange(min=1), default=100, show_default=True
)
@click.option(
    "--smooth",
    help="Amount of smoothing",
    metavar="FLOAT",
    type=click.FloatRange(min=0),
    default=1.25,
    show_default=True,
...
@click.option(
    "--smooth", help="Amount of smoothing", metavar="FLOAT", type=click.FloatRange(min=0), default=0, show_default=True
)
